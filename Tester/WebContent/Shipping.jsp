	...
	<div class="header-bottom"><!--header-bottom-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center"> Shipping & Delivery</h2>   
					</div>			 		
			</div>   
...
Orders are shipped within 10 working days or as per the delivery date agreed at the time of order confirmation and delivering of the shipment 
