...
public class Controller extends HttpServlet {
    ...
    ArrayList<String> products_in_cart_list = new ArrayList<String>();
    ArrayList<String> quantities_in_cart = new ArrayList<String>();
    ArrayList<String> user_product_name = new ArrayList<String>();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            if (username_exists.equals("true")) {
                ...
                if (authentication_status.equals("true")) {
                    ...
                    if (IsAdmin.equals("user")) {
                        ...
                        rd = request.getRequestDispatcher("/shop1.jsp");
                        rd.forward(request, response);
                    } else {
                        session.setAttribute("authentication", "Auth_Success");
        ...
        if (request.getParameter("product") != null) {
            ...
            new Query();
			map = Query.get_product_info(classifier_name);
...
//            System.out.println("product details object name = " + productdetails.getProduct_price());
            ...
            session.setAttribute("productimage", map.get("productimage"));
            ...
            rd = request.getRequestDispatcher("/shop2.jsp");
            rd.forward(request, response);
